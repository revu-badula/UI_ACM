...
@Component({
  ...
  templateUrl: './system-audit-securityrisk.component.html',
  styleUrls: ['./system-audit-securityrisk.component.css']
})
export class SystemAuditSecurityriskComponent implements OnInit {
