...
@Component({
  selector: 'app-audit-businessrisk',
  templateUrl: './system-audit-businessrisk.component.html',
  styleUrls: ['./system-audit-businessrisk.component.css']
})
export class SystemAuditBusinessriskComponent implements OnInit {
