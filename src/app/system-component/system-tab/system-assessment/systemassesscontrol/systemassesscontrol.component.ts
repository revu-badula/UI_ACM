...
@Component({
  selector: 'app-systemassesscontrol',
  templateUrl: './systemassesscontrol.component.html',
  styleUrls: ['./systemassesscontrol.component.css'],
  providers: [ApiserviceService]
})
export class SystemassesscontrolComponent implements OnInit {
