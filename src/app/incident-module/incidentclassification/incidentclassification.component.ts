...
export class IncidentclassificationComponent implements OnInit {
  ...
  constructor(public ref:ChangeDetectorRef,public _location: Location, public datepipe: DatePipe,
     public httpClient: HttpClient, public dialogService: DialogService,
     private info:IncidentinfoComponent,private router:Router) {
