...
export const APP_CONFIG = {
  ...
  getPoliciesByFamId: apiBaseUrl + 'getPoliciesByFamId',
  ...
  getServerDetails: apiBaseUrl + 'getServerDetails',
  getInfraDetails: apiBaseUrl + 'getInfraDetails',
  getGraphAssessmentsCounts: apiBaseUrl + 'getGraphAssessmentsCounts',
  ...
  getPolicyFamilies: apiBaseUrl + 'getPolicyFamilies',
  policyGrpOnstatus: apiBaseUrl + 'policyGrpOnstatus',
  getPolicyAssignment: apiBaseUrl + 'getPolicyAssignment',
  getNISTPolicies: apiBaseUrl + 'getNISTPolicies',
  getPolicyCounts: apiBaseUrl + 'policyHome',
