...
@Component({
  selector: 'app-assessmentpolicyadd',
  templateUrl: './assessmentpolicyadd.component.html',
  styleUrls: ['./assessmentpolicyadd.component.css']
})
export class AssessmentpolicyaddComponent implements OnInit {
  ...
  public users: any;
  policyAccess:Policy;
  policyPost: AssessmentPolicyDTO
  ...
  constructor(private _location: Location, private http: Http, private datepipe: DatePipe,
    ...
    this.policyPost = new AssessmentPolicyDTO();
  ...
  getPolicy() {
    ...
    this._apiservice.getAssessmentPolicyDetails(+appParId)
      .subscribe((data: any) => {
        this.loading = false;
